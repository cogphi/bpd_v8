...
jsPsych.plugins['survey-text-adapt'] = (function() {
...
/// Add in if statement checking for text input
      if (matches[0].querySelector('textarea, input').value == 0 )
        {alert("Please enter a description of yourself before proceeding.");
        }
