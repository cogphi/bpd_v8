...
**************************************************************************/
//	var subject_name = "me"+(Math.random()+"").replace("0.","");
		var subject_name = Cookies.get('subject_id');

;jQuery(document).ready(function($){
"use strict";

//Global options
var path_to_folder = '/bpd_v8_accept/svgavatars/',//the path to main SVG Avatars folder from root dir of your site. The slashes "/" are important!
...
var	hide_share = true, //true will disable share option
	...
	share_credit = 'Created by UoW and UCL';//replase YourSite.com with yours or leave it blank (do NOT delete variable itself!), if you don't want a watermark on avatar for Social share
...
" ");if("png"===save_format){var c=document.getElementById("svga-canvas");canvg(c,a,{ignoreMouse:!0,ignoreDimensions:!0});var c=c.toDataURL("image/png"),b=subject_name+".png"}else"svg"===save_format&&(c=a,b="svgA"+(Math.random()+"").replace("0.","")+".svg");$("#svga-canvas").attr({width:200,height:200});$.ajax({url:path_to_folder+"php/save-ready-avatar.php",type:"post",dataType:"text",data:{imgdata:c,filename:b},cache:!1,success:function(a){"saved"==a?($("#svga-message-text").html(alert_success).removeClass("svga-error"),
